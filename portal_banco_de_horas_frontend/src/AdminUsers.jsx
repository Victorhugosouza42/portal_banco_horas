        ...
        <table className="w-full text-left">
          <thead>
            <tr>
              ...
              <th className="theme-table-head" title="Saldo Banco de Horas">Saldo</th>
              <th className="theme-table-head" title="Saldo de Férias">Saldo F.</th>
